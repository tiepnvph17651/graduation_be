...
public class FakeData {
    ...
    public static List<ShippingHistory> getChildRECEIVED(String username, Integer billId, int parentId) {
        ...
        return List.of(
                ...
                new ShippingHistory(null, billId,null, OrderEnum.DONE.getValue(), username, username, "Hoàn thành", "Đơn hàng đã được thanh toán, giao hàng thành công và không có yêu cầu trả hàng hoặc hoàn tiền", parentId, dateTime.plusDays(4).plusHours(2), dateTime.plusDays(4).plusHours(2))
        );
    }
